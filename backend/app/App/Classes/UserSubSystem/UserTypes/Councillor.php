 ...
 * @description This class is an implementation of the UserAddon class which allows for the creation of a Councillor object which works on top of the user.
...
class Councillor extends UserAddon
{
