 ...
 * Code taken from Stripes documentation
 * Developer: Stripe
 * Date: March 2024
 * Available at: https://dashboard.stripe.com/test/webhooks/create
 */
...
class Webhook extends Endpoint
{
    ...
    public function process($request)
    {
        ...
        /* 
            if payment succeeds, insert a new order and update the item status to reserved. 
            @generated - This code was written with the help of ChatGPT - the usage of curl in particular. 
        */
        switch ($event->type) {
